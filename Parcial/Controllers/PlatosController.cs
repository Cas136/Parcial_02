...
namespace Parcial.Controllers
{
    public class PlatosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id_plato,nombre,imagen,cantidad_vendida,ingresos_generados")] platos platos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_plato,nombre,imagen,cantidad_vendida,ingresos_generados")] platos platos)
        {
