...
namespace Parcial.Controllers
{
    public class MesasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id_mesa,ubicacion,capacidad,estado")] mesas mesas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_mesa,ubicacion,capacidad,estado")] mesas mesas)
        {
            if (id != mesas.id_mesa)
            {
                return NotFound();
